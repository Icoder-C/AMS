...
$statement = $db->query("SELECT COUNT(*) AS temp_user_count FROM users WHERE LOWER(name) LIKE :name",
                        ["name"=>$searchName]);
...
$query = "SELECT * FROM users WHERE LOWER(name) LIKE :name LIMIT $perPage OFFSET $offSet";
$statement = $db->query($query,["name"=>$searchName]);
